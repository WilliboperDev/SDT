...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-06-2025 a las 09:29:14
...
--
-- Base de datos: `sis_direct_telef`
--
...
INSERT INTO `categorias` (`codigo`, `nombre`, `sector`, `es_otro`) VALUES
('DIS_AR', 'Artista/Ilustrador', 'Diseño', 0),
('DIS_DG', 'Diseñador Gráfico', 'Diseño', 0),
('DIS_ED', 'Editor Multimedia', 'Diseño', 0),
('DIS_FO', 'Fotógrafo/Video', 'Diseño', 0),
('DIS_PU', 'Publicista/Marketing', 'Diseño', 0),
('EDU_DU', 'Docente Universitario', 'Educación', 0),
('EDU_ENT', 'Entrenador/Coach', 'Educación', 0),
('EDU_IC', 'Investigador Científico', 'Educación', 0),
('EDU_PRO', 'Profesor de Primaria/Secundaria', 'Educación', 0),
('EDU_TUE', 'Tutor Educativo', 'Educación', 0),
('ING_CIV', 'Ingeniero Civil', 'Ingenierías', 0),
('ING_ELE', 'Ingeniero Eléctrico', 'Ingenierías', 0),
('ING_IND', 'Ingeniero Industrial', 'Ingenierías', 0),
('ING_MEC', 'Ingeniero Mecánico', 'Ingenierías', 0),
('ING_SIS', 'Ingeniero de Sistemas', 'Ingenierías', 0),
('NEG_ADE', 'Administrador de Empresas', 'Negocios', 0),
('NEG_ASE', 'Asesor Financiero', 'Negocios', 0),
('NEG_CON', 'Contador/Auditor', 'Negocios', 0),
('NEG_ECO', 'Economista', 'Negocios', 0),
('NEG_RRH', 'Recursos Humanos', 'Negocios', 0),
('OFI_CON', 'Constructor', 'Oficios', 0),
('OFI_ELE', 'Electricista', 'Oficios', 0),
('OFI_INS', 'Instalador', 'Oficios', 0),
('OFI_MEC', 'Mecánico', 'Oficios', 0),
('OFI_TEC', 'Técnico Especializado', 'Oficios', 0),
('OTRO', 'Otra profesión', 'General', 1),
('SAL_FIS', 'Fisioterapeuta', 'Salud', 0),
('SAL_MED', 'Médico/Enfermero', 'Salud', 0),
('SAL_NUT', 'Nutricionista', 'Salud', 0),
('SAL_PSI', 'Psicólogo/Psiquiatra', 'Salud', 0),
('SAL_TER', 'Terapeuta Alternativo', 'Salud', 0),
('SER_AGC', 'Agente Comercial', 'Servicios', 0),
('SER_ATC', 'Atención al Cliente', 'Servicios', 0),
('SER_CON', 'Consultor/Asesor', 'Servicios', 0),
('SER_LOG', 'Logística/Transporte', 'Servicios', 0),
('SER_SEG', 'Seguridad', 'Servicios', 0),
('TEC_DA', 'Analista de Datos', 'Tecnológico', 0),
('TEC_DEV', 'Desarrollador de Software', 'Tecnológico', 0),
('TEC_DW', 'Diseñador Web/Digital', 'Tecnológico', 0),
('TEC_IT', 'Especialista en TI/Redes', 'Tecnológico', 0),
('TEC_SOP', 'Soporte Técnico', 'Tecnológico', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cod_area`
--
...
--
-- Volcado de datos para la tabla `cod_area`
--

INSERT INTO `cod_area` (`id`, `codigo`) VALUES
(1, '0212'),
(2, '0412'),
(3, '0414'),
(5, '0416'),
...
--
-- Estructura de tabla para la tabla `hora_comer`
--

CREATE TABLE `hora_comer` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `hora_comer`
--

INSERT INTO `hora_comer` (`id`, `hora`, `turno`) VALUES
(1, '08:00 AM', 1),
(2, '09:00 AM', 1),
(3, '10:00 AM', 1),
(4, '11:00 AM', 1),
...
CREATE TABLE `login` (
  ...
  `password` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'los datos encriptados',
...
CREATE TABLE `perfil` (
  ...
  `horario_ap` varchar(20) NOT NULL,
  `horario_ci` varchar(20) NOT NULL,
...
INSERT INTO `perfil` (`id`, `email`, `nombre`, `categoria`, `descripcion`, `telefono`, `estado`, `municipio`, `parroquia`, `direccion`, `horario_ap`, `horario_ci`, `web`, `avatar`) VALUES
(2, 'maria@empresa.com', 'María Gonzalez', 'fotografa profesional', 'Capturando momentos únicos.', '0412-5896325', '1', '1', '1', 'no me acuerdo', '12:00 PM', '09:00 PM', '', 'https://randomuser.me/api/portraits/women/63.jpg'),
(4, 'latira@piedra.com', 'carolina padilla', 'fotografa profesional', '', '', '', '', '', '', '', '', '', 'https://randomuser.me/api/portraits/women/44.jpg'),
(5, 'luis@parcha.com', 'luis parcha', 'Marketing digital', 'Contenido creativo', '', '', '', '', '', '', '', '', 'https://randomuser.me/api/portraits/men/81.jpg'),
(61, 'carlos@carlos.com', 'carlos gomez', 'motorizado', 'soy independiente ando por ahi en la calle caminando poray conociendo', '0212-1234567', '1', '1', '1', 'no me acuerdo en este momento', '08:00 AM', '05:00 PM', 'http://carloselarrecho.com', 'https://randomuser.me/api/portraits/men/32.jpg'),
(97, 'carlos5@carlos.com', 'juan moreno', 'Diseñador Gráfico', 'no tengo, me falta', '0212-5555555', '3', '30', '87', 'tt43t43t', '09:00 AM', '06:00 PM', 'http://carloselocupado.com', 'https://randomuser.me/api/portraits/men/28.jpg'),
(99, 'juanelgay@gmail.com', 'juan perez', 'Psicólogo/Psiquiatra', 'si tienes problemas estoy para escucharte y consolarte', '0212-9888888', '14', '229', '619', 'reservado por ahora.', '08:00 AM', '09:00 PM', '', 'https://randomuser.me/api/portraits/men/22.jpg'),
(100, 'ana.torres@mail.com', 'Ana Torres', 'Entrenador/Coach', 'vvv', '0212-5551234', '', '', '', '', '', '', '', 'https://randomuser.me/api/portraits/women/1.jpg'),
(101, 'luis.perez@mail.com', 'Luis Pérez', 'Electricista', '', '0412-5555678', '', '', '', '', '', '', '', 'https://randomuser.me/api/portraits/men/2.jpg'),
(102, 'marta.gomez@mail.com', 'Marta Gómez', 'Recursos Humanos', 'sfewfewf', '0424-5558765', '', '', '', '', '', '', '', 'https://randomuser.me/api/portraits/women/3.jpg'),
(103, 'el.lucho@mail.com', 'luciano parada', 'Mecánico', 'si quieres gasolina en tu vida, yo te la doy', '0416-5554321', '', '', '', 'el rey de la vega', '', '', '', 'https://randomuser.me/api/portraits/men/4.jpg'),
(104, 'sofia.ruiz@mail.com', 'Sofía Ruiz', 'Tutor Educativo', 'fgewfwe', '0426-5552468', '', '', '', '', '', '', '', 'https://randomuser.me/api/portraits/women/5.jpg');
...
INSERT INTO `relaciones` (`id`, `seguidor_id`, `seguido_id`, `fecha`) VALUES
(245, 61, 2, '2025-06-11 00:43:27'),
(336, 61, 99, '2025-06-24 20:25:28'),
(337, 99, 61, '2025-06-24 21:58:07'),
(339, 61, 4, '2025-06-25 03:24:21'),
(340, 99, 4, '2025-06-26 21:54:18');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `temp_login`
--
...
CREATE TABLE `temp_login` (
  ...
  `hora_ini` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `cod_area`
--
ALTER TABLE `cod_area`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `codigo` (`codigo`);
...
--
-- Indices de la tabla `hora_comer`
--
ALTER TABLE `hora_comer`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `temp_login`
--
...
--
-- AUTO_INCREMENT de la tabla `cod_area`
--
ALTER TABLE `cod_area`
...
--
-- AUTO_INCREMENT de la tabla `hora_comer`
--
ALTER TABLE `hora_comer`
...
--
-- AUTO_INCREMENT de la tabla `temp_login`
--
ALTER TABLE `temp_login`
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `login` (`id`);

--
-- Filtros para la tabla `relaciones`
--
ALTER TABLE `relaciones`
  ADD CONSTRAINT `relaciones_ibfk_1` FOREIGN KEY (`seguidor_id`) REFERENCES `perfil` (`id`),
  ADD CONSTRAINT `relaciones_ibfk_2` FOREIGN KEY (`seguido_id`) REFERENCES `perfil` (`id`);
COMMIT;
